...
$searchData = array(
    ...
    "SearchOp" => 'ContainsOp',
    "Value" => 'Platinum Classic Wedder Size L',
);
...
?>
<h2>Get Items by Search (String: SKU)</h2>
<table class="table table-striped">
    ...
    <tr>
        ...
        <td>
            ...
            print '<strong>Description:</strong> ' . $response->GetActiveItemsResult->ActiveItem->Description . '<br />';
            print '<strong>Price: $</strong>' . $response->GetActiveItemsResult->ActiveItem->Price . '<br />';
            print '<img src="' . $response->GetActiveItemsResult->ActiveItem->Images->ItemImage->URL . '" style="width: 80px; height: 80px;"/>';
