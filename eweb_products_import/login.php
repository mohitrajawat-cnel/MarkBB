...
if(isset($_POST['user_login']))
{
    ...
    $select = "SELECT * from `user_login` where `username` ='".$username."' && `password`='".$password."'";
    ...
    if(mysqli_num_rows($row) > 0)
    {
        ...
        $_SESSION['user_id'] = $username;
            ...
            <script>
                window.location.href='<?php echo Client_site_url ?>/eweb_products_import/allActive.php';
            </script>
    ...
    {
        $error = "Please Use Correct Details";
    }
...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <form method="post">
      ...
      <button type="submit" name="user_login" class="fadeIn fourth">Log In</button>
    </form>

    <!-- Remind Passowrd -->
    <div id="formFooter">
      <a class="underlineHover" href="#">Login Into Dashboard</a>
    </div>
